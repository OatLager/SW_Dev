...
class MAVXML(object):
    ...
    def __init__(self, filename, wire_protocol_version=PROTOCOL_2_0):
        ...
        if wire_protocol_version == PROTOCOL_2_0:
            ...
            print("Available versions are: %s " % (PROTOCOL_2_0))
