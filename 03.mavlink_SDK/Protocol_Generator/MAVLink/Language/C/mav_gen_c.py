...
import os
from ... import mav_parse, mav_template

t = mav_template.MAVTemplate()
...
# mavlink message 항목 별 header file 생성
...
def copy_fixed_headers(directory, xml):
    ...
    srcpath = os.path.join(basepath, 'include_v%s' % xml.wire_protocol_version)
