...
static void mavlink_test_oem7_bestpos(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_OEM7_BESTPOS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_oem7_bestpos_t packet_in = {
        123.0,179.0,235.0,963498712,963498920,241.0,963499336,297.0,325.0,353.0,381.0,409.0,"IJK",197
    };
    mavlink_oem7_bestpos_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.lat = packet_in.lat;
        packet1.lon = packet_in.lon;
        packet1.hgt = packet_in.hgt;
        packet1.sol_status = packet_in.sol_status;
        packet1.pos_type = packet_in.pos_type;
        packet1.undulation = packet_in.undulation;
        packet1.datum_id = packet_in.datum_id;
        packet1.lat_d = packet_in.lat_d;
        packet1.lon_d = packet_in.lon_d;
        packet1.hgt_d = packet_in.hgt_d;
        packet1.diff_age = packet_in.diff_age;
        packet1.sol_age = packet_in.sol_age;
        packet1.solnSVs = packet_in.solnSVs;
        
        mav_array_memcpy(packet1.stn_id, packet_in.stn_id, sizeof(char)*4);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_OEM7_BESTPOS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_OEM7_BESTPOS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_oem7_bestpos_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_oem7_bestpos_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_oem7_bestpos_pack(system_id, component_id, &msg , packet1.sol_status , packet1.pos_type , packet1.lat , packet1.lon , packet1.hgt , packet1.undulation , packet1.datum_id , packet1.lat_d , packet1.lon_d , packet1.hgt_d , packet1.stn_id , packet1.diff_age , packet1.sol_age , packet1.solnSVs );
    mavlink_msg_oem7_bestpos_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_oem7_bestpos_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sol_status , packet1.pos_type , packet1.lat , packet1.lon , packet1.hgt , packet1.undulation , packet1.datum_id , packet1.lat_d , packet1.lon_d , packet1.hgt_d , packet1.stn_id , packet1.diff_age , packet1.sol_age , packet1.solnSVs );
    mavlink_msg_oem7_bestpos_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_oem7_bestpos_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_oem7_bestpos_send(MAVLINK_COMM_1 , packet1.sol_status , packet1.pos_type , packet1.lat , packet1.lon , packet1.hgt , packet1.undulation , packet1.datum_id , packet1.lat_d , packet1.lon_d , packet1.hgt_d , packet1.stn_id , packet1.diff_age , packet1.sol_age , packet1.solnSVs );
    mavlink_msg_oem7_bestpos_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("OEM7_BESTPOS") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_OEM7_BESTPOS) != NULL);
#endif
}

static void mavlink_test_oem7_bestvel(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_OEM7_BESTVEL >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_oem7_bestvel_t packet_in = {
        123.0,179.0,235.0,963498712,963498920,241.0,269.0
    };
    mavlink_oem7_bestvel_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.hor_spd = packet_in.hor_spd;
        packet1.trk_gnd = packet_in.trk_gnd;
        packet1.vert_spd = packet_in.vert_spd;
        packet1.sol_status = packet_in.sol_status;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_OEM7_BESTVEL_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_OEM7_BESTVEL_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_oem7_bestvel_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_oem7_bestvel_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_oem7_bestvel_pack(system_id, component_id, &msg , packet1.sol_status , packet1.vel_type , packet1.latency , packet1.age , packet1.hor_spd , packet1.trk_gnd , packet1.vert_spd );
    mavlink_msg_oem7_bestvel_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_oem7_bestvel_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sol_status , packet1.vel_type , packet1.latency , packet1.age , packet1.hor_spd , packet1.trk_gnd , packet1.vert_spd );
    mavlink_msg_oem7_bestvel_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_oem7_bestvel_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_oem7_bestvel_send(MAVLINK_COMM_1 , packet1.sol_status , packet1.vel_type , packet1.latency , packet1.age , packet1.hor_spd , packet1.trk_gnd , packet1.vert_spd );
    mavlink_msg_oem7_bestvel_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("OEM7_BESTVEL") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_OEM7_BESTVEL) != NULL);
#endif
}

static void mavlink_test_oem7_heading(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_OEM7_HEADING >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_oem7_heading_t packet_in = {
        963497464,963497672,73.0,101.0,129.0,157.0,185.0
    };
    mavlink_oem7_heading_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.sol_status = packet_in.sol_status;
        packet1.pos_type = packet_in.pos_type;
        packet1.length = packet_in.length;
        packet1.heading = packet_in.heading;
        packet1.pitch = packet_in.pitch;
        packet1.hdg_std_dev = packet_in.hdg_std_dev;
        packet1.ptch_std_dev = packet_in.ptch_std_dev;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_OEM7_HEADING_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_OEM7_HEADING_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_oem7_heading_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_oem7_heading_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_oem7_heading_pack(system_id, component_id, &msg , packet1.sol_status , packet1.pos_type , packet1.length , packet1.heading , packet1.pitch , packet1.hdg_std_dev , packet1.ptch_std_dev );
    mavlink_msg_oem7_heading_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_oem7_heading_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.sol_status , packet1.pos_type , packet1.length , packet1.heading , packet1.pitch , packet1.hdg_std_dev , packet1.ptch_std_dev );
    mavlink_msg_oem7_heading_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_oem7_heading_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_oem7_heading_send(MAVLINK_COMM_1 , packet1.sol_status , packet1.pos_type , packet1.length , packet1.heading , packet1.pitch , packet1.hdg_std_dev , packet1.ptch_std_dev );
    mavlink_msg_oem7_heading_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("OEM7_HEADING") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_OEM7_HEADING) != NULL);
#endif
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_oem7_bestpos(system_id, component_id, last_msg);
    mavlink_test_oem7_bestvel(system_id, component_id, last_msg);
    mavlink_test_oem7_heading(system_id, component_id, last_msg);
}
