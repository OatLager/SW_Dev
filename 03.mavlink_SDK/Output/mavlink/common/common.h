...
#define MAVLINK_COMMON_XML_HASH -1571248875415530418
...
#include "./mavlink_msg_oem7_bestpos.h"
#include "./mavlink_msg_oem7_bestvel.h"
#include "./mavlink_msg_oem7_heading.h"
